...
public class SpecificationGeneric<T> {
    ...
    public Specification<T> getOrSpecificationFromFilters(List<Filter> filters) {
        if (filters.isEmpty()) {
            return null;
        }
        Specification<T> specification = createSpecification(filters.remove(0));
