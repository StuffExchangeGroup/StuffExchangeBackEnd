...
/**
 * REST controller for managing {@link pbm.com.exchange.domain.Purchase}.
 */
@RestController
@RequestMapping("/api")
public class PurchaseResource {
    ...
    public ResponseEntity<List<PurchaseDTO>> getAllPurchases(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
