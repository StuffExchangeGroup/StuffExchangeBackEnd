...
/**
 * REST controller for managing {@link pbm.com.exchange.domain.Level}.
 */
@RestController
@RequestMapping("/api")
public class LevelResource {
     ...
     */
    @GetMapping("/levels")
    public ResponseEntity<List<LevelDTO>> getAllLevels(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
