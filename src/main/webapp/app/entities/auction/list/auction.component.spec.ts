...
describe('Auction Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'auction', component: AuctionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.auctions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
