...
describe('NotificationToken Management Component', () => {
  let comp: NotificationTokenComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'notification-token', component: NotificationTokenComponent }]),
        HttpClientTestingModule,
      ],
      declarations: [NotificationTokenComponent],
      providers: [
        {
      ...
      .overrideTemplate(NotificationTokenComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.notificationTokens?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
