...
export class NationalityComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.nationalityService
      ...
      .subscribe({
        next: (res: HttpResponse<INationality[]>) => {
  ...
  trackId(index: number, item: INationality): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: INationality[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
