...
import pbm.com.exchange.repository.MessageRepository;
import pbm.com.exchange.service.dto.MessageDTO;
import pbm.com.exchange.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).read(DEFAULT_READ).isDelete(DEFAULT_IS_DELETE);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().title(UPDATED_TITLE).content(UPDATED_CONTENT).read(UPDATED_READ).isDelete(UPDATED_IS_DELETE);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getIsDelete()).isEqualTo(DEFAULT_IS_DELETE);
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.title(UPDATED_TITLE).content(UPDATED_CONTENT).read(UPDATED_READ).isDelete(UPDATED_IS_DELETE);
        ...
        assertThat(testMessage.getIsDelete()).isEqualTo(UPDATED_IS_DELETE);
    }
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.title(UPDATED_TITLE).content(UPDATED_CONTENT).read(UPDATED_READ).isDelete(UPDATED_IS_DELETE);
