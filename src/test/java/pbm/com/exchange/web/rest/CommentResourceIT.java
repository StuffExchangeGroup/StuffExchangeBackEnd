...
import pbm.com.exchange.repository.CommentRepository;
import pbm.com.exchange.service.dto.CommentDTO;
import pbm.com.exchange.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).createdDate(DEFAULT_CREATED_DATE).image(DEFAULT_IMAGE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).image(UPDATED_IMAGE);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).image(UPDATED_IMAGE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).image(UPDATED_IMAGE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).image(UPDATED_IMAGE);
