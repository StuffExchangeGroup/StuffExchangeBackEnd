...
class CategoryResourceIT {
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).thumbnail(UPDATED_THUMBNAIL).active(UPDATED_ACTIVE);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).active(UPDATED_ACTIVE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).thumbnail(UPDATED_THUMBNAIL).active(UPDATED_ACTIVE);
