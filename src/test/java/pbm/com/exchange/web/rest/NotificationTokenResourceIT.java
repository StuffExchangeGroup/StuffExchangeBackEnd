...
class NotificationTokenResourceIT {
    ...
    void createNotificationToken() throws Exception {
        ...
        NotificationTokenDTO notificationTokenDTO = notificationTokenMapper.toDto(notificationToken);
        restNotificationTokenMockMvc
            .perform(
                post(ENTITY_API_URL)
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(notificationTokenDTO))
            )
    ...
    void putNewNotificationToken() throws Exception {
        ...
        NotificationTokenDTO notificationTokenDTO = notificationTokenMapper.toDto(updatedNotificationToken);

        restNotificationTokenMockMvc
            .perform(
                put(ENTITY_API_URL_ID, notificationTokenDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(notificationTokenDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(notificationTokenDTO))
            )
    ...
    void patchNonExistingNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, notificationTokenDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(notificationTokenDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(delete(ENTITY_API_URL_ID, notificationToken.getId()).accept(MediaType.APPLICATION_JSON))
